    ...
    <div>
      <Dialog open={open} onClose={handleClose}>
        ...
        <DialogContent>
          ...
          <span style={{fontSize:"10px", fontStyle: "italic", color:"red"}}>*Al agregar un nuevo cliente, automáticamente se crea una cuenta por cobrar con un saldo de ¢10000</span>
        </DialogContent>
